 ...
 * @author delri
 */
public class ViewGerenciarFuncao extends javax.swing.JFrame {

    /**
     * Creates new form ViewGerenciarFuncao
     */
    public ViewGerenciarFuncao() {
        initComponents();
        ReadJTable();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Adicionar Função"));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(txtAdicionar, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ReadJTable() {
        DefaultTableModel modelo = (DefaultTableModel) tableFuncao.getModel();
        FuncaoDAO fdao = new FuncaoDAO();
        modelo.setNumRows(0);
        for (Funcao f : fdao.Read()) {
    ...
    private void btnVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoltarActionPerformed
        ...
        ViewGerenciarFuncao.this.dispose();
    }//GEN-LAST:event_btnVoltarActionPerformed

    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        // TODO add your handling code here:
        if (txtAdicionar.getText() != null && txtAdicionar.getText() != "") {
            FuncaoDAO fdao = new FuncaoDAO();
            fdao.Create(txtAdicionar.getText());
        } else {
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (tableFuncao.getSelectedRow() != -1) {
            FuncaoDAO fdao = new FuncaoDAO();
            fdao.Delete((int)tableFuncao.getValueAt(tableFuncao.getSelectedRow(),0));
            ReadJTable();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewGerenciarFuncao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewGerenciarFuncao().setVisible(true);
            }
        });
    }
